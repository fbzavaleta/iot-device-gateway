...
API 
*/
#define SERVER_IP "192.168.15.5" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Vivo Fibra_AMORIM " //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"confusao"   //modificar nac2-B
