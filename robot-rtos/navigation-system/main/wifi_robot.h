...
API 
*/
#define SERVER_IP "192.168.1.204" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Rans0nwar3" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"CryptoGhr@pHy_Ha$h1x1"   //modificar nac2-B
