...
API 
*/
#define SERVER_IP "192.168.0.114" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"FamiliaMarques" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"marquesfamilia@123"   //modificar nac2-B
