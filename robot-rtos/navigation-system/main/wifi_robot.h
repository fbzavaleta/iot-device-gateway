...
API 
*/
#define SERVER_IP "192.168.132.1" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Wallace" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"300699"   //modificar nac2-B
