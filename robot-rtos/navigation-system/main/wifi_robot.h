...
API 
*/
#define SERVER_IP "192.168.0.52" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"HomeDanilo" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"dallp@@joh311"   //modificar nac2-B
