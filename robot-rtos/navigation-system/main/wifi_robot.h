...
API 
*/
#define SERVER_IP "192.168.15.19" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Storm" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"WxW12kH2QSt0rm"   //modificar nac2-B
