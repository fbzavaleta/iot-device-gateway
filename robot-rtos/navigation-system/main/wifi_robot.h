...
API 
*/
#define SERVER_IP "192.168.15.11" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Henri" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"H3Nq10203040"   //modificar nac2-B
