...
API 
*/
#define SERVER_IP "192.168.15.106" //modificar nac2-B
...
*/
#define EXAMPLE_ESP_WIFI_SSID 	"Hermes-VIVO-2.4G" //modificar nac2-B
#define EXAMPLE_ESP_WIFI_PASS 	"AsAboveSoBelow"   //modificar nac2-B
