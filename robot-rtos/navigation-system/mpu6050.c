//checkpoint2C- Adcicionar suporte
/*
Drivers
*/
...
#define SERVER_IP "179.208.228.63"
#define SERVER_PORT 80
#define EXAMPLE_ESP_WIFI_SSID 	"ResMont Guest"
#define EXAMPLE_ESP_WIFI_PASS 	"CgM002347500"
...
void Task_Socket ( void * pvParameter ) 
{
    ...
    for(;;) 
    {
		...
		/**
		 * Tenta realizar a conexão socket com o servidor; 
		 * SE a conexão ocorrer com sucesso, retorna 0, se não -1;
		 */
		...
		if( rc == -1 ) 
		{
			...
			/**
			 * Espera 5 segundos antes de abrir um novo socket;
			 */
...
void Task_SendReceive ( void * pvParameter ) 
{
	...
	/**
	 * Recebe socket da conexão com o servidor web;
	 */
	...
	const char * msg_post = \
        ...
        "Connection: close\n"
        "X-THINGSPEAKAPIKEY: TRQRNYC272OZVMJD\n"
