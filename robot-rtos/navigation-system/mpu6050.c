...
#define EXAMPLE_ESP_WIFI_SSID 	"Hermes-VIVO_2.4G"
#define EXAMPLE_ESP_WIFI_PASS 	"AsAboveSoBelow"
...
void Task_SendReceive ( void * pvParameter ) 
{
	...
	const char * msg_post = \
        ...
        "Connection: close\n"
        "X-THINGSPEAKAPIKEY: H1OTQIMA51XLRS0B\n"
	...
	char databody[50];
  	sprintf( databody, "{H1OTQIMA51XLRS0B&field1=%d&field2=%d&field3=%d}", data_package[0], xSocket->y_accel, xSocket->z_accel);
