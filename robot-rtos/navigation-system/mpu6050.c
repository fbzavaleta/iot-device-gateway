...
#define EXAMPLE_ESP_WIFI_PASS 	"w82k3nt9e3"
...
void Task_SendReceive ( void * pvParameter ) 
{
	...
	const char * msg_post = \
        ...
        "Connection: close\n"
        "X-THINGSPEAKAPIKEY: XU8GRT35OTPSZ9EU\n"
	...
	char databody[50];
  	sprintf( databody, "{XU8GRT35OTPSZ9EU&field1=%d&field2=%d&field3=%d}", data_package[0], xSocket->y_accel, xSocket->z_accel);
