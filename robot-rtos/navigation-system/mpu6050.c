...
#define EXAMPLE_ESP_WIFI_SSID 	"Rans0nwar3"
#define EXAMPLE_ESP_WIFI_PASS 	"CryptoGhr@pHy_Ha$h1x1"
...
void Task_SendReceive ( void * pvParameter ) 
{
	...
	char databody[50];
  	sprintf( databody, "{T9CW2EGCBRW133D3&field1=%d&field2=%d&field3=%d}", data_package[0], xSocket->y_accel, xSocket->z_accel);
