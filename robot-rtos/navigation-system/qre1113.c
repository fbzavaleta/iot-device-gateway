...
channel_struct alalogic_read()
{
    channel_struct channelStruct;

        channelStruct.adc0_chars = esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_0), &adc0_chars);
        channelStruct.adc3_chars = esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_3), &adc3_chars);
