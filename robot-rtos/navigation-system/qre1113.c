...
adc_rm81195_struct alalogic_read()

{   
    adc_rm81195_struct adc_rtn;

    adc_rtn.voltage_ADC1C0 = esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_0), &adc0_chars);
    adc_rtn.voltage_ADC1C3 = esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_3), &adc3_chars);
